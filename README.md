...
- **Full-Stack Development** — MERN Stack, REST APIs, Authentication Systems
- **AI & Machine Learning** — Model training, data pipelines, industrial AI applications
- **DSA & Problem Solving** — Daily LeetCode practice, Java
- **Cloud & DevOps** — Cloud deployment, environment management
...
|---------|-------------|-------|
| [Scalable MERN Commerce Platform](https://github.com/Aniketsahoo228/scalable-mern-commerce-platform) | Production-ready e-commerce with auth, product management & order processing | MERN |
